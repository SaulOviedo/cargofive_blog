						...
						<form class="form" method="POST" action="{{ route('register') }}">
							...
							<div class="card-content" style="margin-top:10px;">
                                <div class="input-group">
									...
									<input type="text" id="name" name="name" class="form-control" placeholder="Nombre..." value="{{ old('name') }}" required autocomplete="name">
                                    @error('name')
								...
								<div class="input-group">
									...
									<input type="password" id="password" name="password" placeholder="Password..." class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password"/>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
								...
								<div class="input-group">
									...
									<input type="password" id="password_confirmation" name="password_confirmation" placeholder="Password..." class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password"/>
                                </div>
